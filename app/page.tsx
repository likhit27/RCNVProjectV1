    ...
    <main className="min-h-screen bg-[#002664] flex flex-col items-center justify-center p-6 text-white">
      <div className="w-full max-w-md space-y-8 text-center">
        <div>
          ...
          <p className="mt-2 text-white/60 text-sm">Rotary Club Nagpur Vision — Club Management</p>
        </div>

        <div className="grid gap-3">
          <Link href="/club/rotary-nagpur-vision"
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-5 text-left text-sm space-y-1">
          ...
          <p><span className="text-white/50">Club:</span> rotary-nagpur-vision</p>
