    ...
    <main className="min-h-screen bg-[#002664] flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <p className="text-xs font-semibold uppercase tracking-widest text-[#F7A81B] mb-1">RCNV Admin</p>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <label className="block">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-sm outline-none focus:border-[#002664] focus:ring-2 focus:ring-[#002664]/10"
              />
            </label>
            <label className="block">
